...
def savefile(epoch,loss_train, acc_train,loss_val, acc_val):
    with open('/media/ubuntu/My Passport/tmy/xueqi/Bert-Chinese-Text-Classification-Pytorch-master/THUCNews/data/1.txt','a',encoding="utf-8") as f:
    ...
    #test
def savefile1(epoch,loss_test, acc_test):
    with open('/media/ubuntu/My Passport/tmy/xueqi/Bert-Chinese-Text-Classification-Pytorch-master/THUCNews/data/1.txt','a',encoding="utf-8") as f:
