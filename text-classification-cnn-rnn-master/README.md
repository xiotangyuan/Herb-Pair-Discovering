#代码地址；
打乱顺序
https://blog.csdn.net/weixin_40931845/article/details/83865877#comments
https://blog.csdn.net/qq_35697978/article/details/81059701
已经跑通 
cnn和rnn两种预测
####cd  G:\课外\文本分类\药对\text-classification-cnn-rnn-master
####activate PY36T13Scikit_learn
####python run_cnn.py train
运行 python run_cnn.py train
再python run_cnn.py test
