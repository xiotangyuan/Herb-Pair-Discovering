...
if __name__ == '__main__':
    ...
    print(len(open('G:/课外/文本分类/药对/text-classification-cnn-rnn-master/data/cnews/cnews.train.txt', 'r', encoding='utf-8').readlines()))
    print(len(open('G:/课外/文本分类/药对/text-classification-cnn-rnn-master/data/cnews/cnews.test.txt', 'r', encoding='utf-8').readlines()))
    print(len(open('G:/课外/文本分类/药对/text-classification-cnn-rnn-master/data/cnews/cnews.val.txt', 'r', encoding='utf-8').readlines()))
